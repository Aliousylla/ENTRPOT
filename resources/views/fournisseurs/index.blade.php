...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <button style=" background: rgb(255, 187, 0); color: rgb(0, 0, 0) " type="button" class="btn btn" data-bs-toggle="modal" data-bs-target="#createModal">Ajouter un fournisseur <i class="fa fa-plus-circle" aria-hidden="true"></i></button>
    </div>
